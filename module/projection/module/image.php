    ...
    function execute() {
        ...
        switch ($this->in['k']) {
            case 'przekroj-zachod':
                ...
                break;
            case 'przekroj-zachod-arch2':
                $this->template = 'projection/view/przekroj-zachod_arch2.phtml';
                break;
            ...
            case 'przekroj-wschod':
                ...
                break;
            case 'przekroj-wschod-arch2':
                $this->template = 'projection/view/przekroj-wschod_arch2.phtml';
                break;
            ...
            case 'front-poludnie':
                $this->template = 'projection/view/front-poludnie.phtml';
                break;
            case 'front-poludnie-arch2':
                $this->template = 'projection/view/front_poludnie_luk_arch2.phtml';
                break;
            ...
            case 'poddasze':
                ...
                break;
             case 'poddasze-arch2':
                $this->template = 'projection/view/poddasze_arch2.phtml';
                break;
            case 'poddasze-arch':
            ...
            case 'parter-arch':
                ...
                break;
             case 'parter-arch2':
                $this->template = 'projection/view/parter_arch2.phtml';
                break;
            case 'parter-inwent':
                $this->template = 'projection/view/parter-inwent.phtml';
                break;
            case 'parter-nowy':
                $this->template = 'projection/view/parter-new.phtml';
                break;
            case 'parter':
            default:
...
$this->template = 'projection/view/screen.phtml';
